...
export const addToCart = (id: string, qty: number) => {
  return async (dispatch: Dispatch<Action>, getState: any) => {
    const { data } = await axios.get(
      `http://localhost:10100/api/v1/products/${id}`
    );
...
export const getProducts = (page: number) => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:10100/api/v1/products?pageNumber=${page}`
      );
...
export const quickSearchProducts = (keyword: number) => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:10100/api/v1/products/search?keyword=${keyword}`
      );
  ...
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.post(
        `http://localhost:10100/api/v1/products/${id}/reviews`,
        { rating, comment },
        config
      );
...
export const register = (name: string, email: string, password: string) => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.post(
        "http://localhost:10100/api/v1/users",
        formData,
        config
      );
...
export const login = (email: string, password: string) => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.post(
        "http://localhost:10100/api/v1/users/login",
        formData,
        config
      );
...
export const createOrder = (
  ...
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.post(
        "http://localhost:10100/api/v1/orders",
        formData,
        config
      );
...
export const getOrder = (id: any) => {
  return async (dispatch: Dispatch<Action>, getState: any) => {
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:10100/api/v1/orders/${id}`,
        config
      );
  ...
  return async (dispatch: Dispatch<Action>, getState: any) => {
    try {
      ...
      const { data } = await axios.put(
        `http://localhost:10100/api/v1/orders/${id}/pay`,
        paymentResult,
        config
      );
...
export const deliverOrder = (id: string) => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.put(
        `http://localhost:10100/api/v1/orders/${id}/deliver`,
        {},
        config
      );
...
export const createProduct = (
  ...
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.post(
        `http://localhost:10100/api/v1/products`,
        formData,
        config
      );
...
export const getTopProducts = () => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:10100/api/v1/products/top`
      );
...
export const getMyOrders = () => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:10100/api/v1/orders/myorders`,
        config
      );
...
export const updateProfile = (
  ...
  return async (dispatch: Dispatch<Action>, getState: any) => {
    try {
      ...
      const { data } = await axios.put(
        `http://localhost:10100/api/v1/users/profile`,
        formData,
        config
      );
...
export const updateUser = (id: string, isAdmin: boolean) => {
  return async (dispatch: Dispatch<Action>) => {
    try {
      ...
      const { data } = await axios.put(
        `http://localhost:10100/api/v1/users/${id}`,
        formData,
        config
      );
